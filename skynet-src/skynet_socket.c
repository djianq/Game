...
static int check_wsz(struct skynet_context *ctx, int id, void *buffer, int64_t wsz) 
{
	if(wsz < 0) 
	{
		return -1;
...
const char *skynet_socket_udp_address(struct skynet_socket_message *msg, int *addrsz) 
{
